    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-8 col-sm-12 col-12 bkground">
                ...
                <div class="container" style="background:fixed;">
                ...
                <div class="container mt-4 ml-md-3 cont" style="height:90vh;">
                    <div class="row">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="card" style="width: 175px; height: 160px; background-color:#101E4B;">
                                <div class="card-body">
                                <div class="row">
                                        <div class="font-weight-bold" style="font-size: 40px; padding-top:5px;">R</div>
                                    </div>
                                    <div class="row mt-0">
                                        <div class="ml-0"><a href="" style="font-size: 64px; font-weight:bold; margin-right:50px; text-decoration:none;">1.8</a><small style="color:  #007BFF; font-weight:bold;">%</small></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="card" style="width: 175px; height: 160px; background-color:#101E4B;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row mt-0">
                                        <div class="ml-0"><a href="" style="font-size: 64px; font-weight:bold; margin-right:50px; text-decoration:none;">2.1</a><small style="color:  #007BFF; font-weight:bold;">%</small></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-4">
                            <div class="card" style="width: 175px; height: 160px; background-color:#101E4B;">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="font-weight-bold" style="font-size: 40px; padding-top:5px;">T</div>
                                    </div>
                                    <div class="row mt-0">
                                        <div class="ml-0"><a href="" style="font-size: 64px; font-weight:bold; margin-right:50px; text-decoration:none;">1.9</a><small style="color:  #007BFF; font-weight:bold;">%</small></div>
                                    </div>
                                </div>
                            </div>
                        </div>
