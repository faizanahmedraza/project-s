...
<body>
    <nav class="navbar mb-0" style="background-color: black;">
        <div class="container">
            <a href="./searchview/meter2.php"><i style="font-size: 40px!important; color:white" class="material-icons-outlined coloricon float-left">keyboard_arrow_left</i> </a>
            <div class="d-flex justify-content-center font-weight-bold" style="text-align:center"> Meter <br> Voltage</div>
