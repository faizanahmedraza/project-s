                        ...
                        <div class="col-6 col-md-4">
                            <div class="card" style="width: 175px; height: 160px; background-color:#101E4B;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row mt-0">
                                        <div class="ml-0"><a href="" style="font-size: 64px; font-weight:bold; margin-right:70px; text-decoration:none;">5</a><small style="color:  #007BFF; font-weight:bold;">%</small></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="card" style="width: 175px; height: 160px; background-color:#101E4B;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row mt-0">
                                        <div class="ml-0"><a href="" style="font-size: 64px; font-weight:bold; margin-right:70px; text-decoration:none;">8</a><small style="color:  #007BFF; font-weight:bold;">%</small></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            on: {
                slideChange() {
                    ...
                    if (swiper.activeIndex === 0) {
                        ...
                        var url = swiper.$wrapperEl.children('.swiper-slide').eq(swiper.activeIndex);
                        console.log(url);
                        window.location = "thdv.php";
                    } else if (swiper.activeIndex === 6) {
                        var url = swiper.$wrapperEl.children('.swiper-slide').eq(swiper.activeIndex);
                        console.log(url);
                        window.location = "iharm.php";
