...
<body>
    ...
    <div class="container">
                            ...
                            <div class="row">
                                <div class="container text-center">
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="justify-content-center" style=" font-size:18px; color:#70747a;">no filters connected</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="ml-3 ml-md-0 mb-2 font-weight-bold" style="font-size: 30px;">Potential Savings</div>
