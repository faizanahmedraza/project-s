...
<body>
  ...
  <div class="container">
    ...
    <div class="mt-5 text-center">
      <button type="button" class="text-white font-weight-bold" style="font-size:34px; text-align: center; outline: none; text-shadow:none; cursor: pointer;" onclick="window.open('../3phase-bank.php')">VIEW <br> GRAPH</button>
      ...
      on: {
        slideChange() {
          ...
          if (swiper.activeIndex === 0) {
            ...
            console.log(url);
            window.location = "cap.bank2.php";
          } else if (swiper.activeIndex === 2) {
            var url = swiper.$wrapperEl.children('.swiper-slide').eq(swiper.activeIndex);
            console.log(url);
            window.location = "cap.bank4.php";
          }
        }
      }
    });
