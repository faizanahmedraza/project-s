                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="card" style="width: 175px; height: 160px; background-color:#041a24;">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="font-weight-bold" style="font-size: 40px; padding-top:5px;">P</div>
                                    </div>
                                    <div class="row mt-0">
                                        <div class="ml-0"><a href="" style="font-size: 64px; font-weight:bold; margin-right:10px; text-decoration:none;">1.1M</a><small style="color:  #007BFF; font-weight:bold;">W</small></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-4">
                            <div class="card" style="width: 175px; height: 160px; background-color:#041a24;">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="font-weight-bold" style="font-size: 40px; padding-top:5px;">PF</div>
                                    </div>
                                    <div class="row mt-0">
                                        <div class="ml-0"><a href="" style="font-size: 64px; font-weight:bold; margin-right:30px; text-decoration:none;">0.95</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="card" style="width: 175px; height: 160px; background-color:#041a24;">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="font-weight-bold" style="font-size: 40px; padding-top:5px;">Losses</div>
                                    </div>
                                    <div class="row mt-0">
                        ...
                        <div class="col-6 col-md-4">
                            <div class="card" style="width: 175px; height: 160px; background-color:#041a24;">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="font-weight-bold" style="font-size: 40px; padding-top:5px;">Freq.</div>
                                    </div>
                                    <div class="row mt-0">
                                        <div class="ml-0"><a href="" style="font-size: 64px; font-weight:bold; margin-right:10px; text-decoration:none;">50</a><small style="color:  #007BFF; font-weight:bold;">Hz</small></div>
                                    </div>
                                </div>
                            </div>
                        </div>
