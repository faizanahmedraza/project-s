        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-8 col-sm-12 col-12 bkground">
                <nav class="navbar p-0 m-0">
                    <a href="../home.php"><i style="font-size: 54px!important; color:white" class="material-icons-outlined float-left">keyboard_arrow_left</i> </a>
                    <span style="font-weight:bold!important;" class="d-flex justify-content-center">ALL Cap. Banks</span>
                    <button class="d-flex justify-content-end" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="card text-center mt-4 mx-auto" style="width: 80%; height: 200px; background-color: #041a24;">
                    <div class="card-body m-0 p-0">
                        <a href="bank1.php" style="font-size: 64px; color: #26b5e3; text-decoration:none; padding-bottom:0%"><strong>122</strong><sub>kvarh</sub></a>
            ...
            on: {
                slideChange() {
                    ...
                    if (swiper.activeIndex === 4) {
                        ...
                        console.log(url);
                        window.location = "allcapsbank5.php";
                    } else if (swiper.activeIndex === 6) {
                        var url = swiper.$wrapperEl.children('.swiper-slide').eq(swiper.activeIndex);
                        console.log(url);
                        window.location = "allcapsbank2.php";
                    }
                }
            }
        });
