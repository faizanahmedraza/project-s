        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-8 col-sm-12 col-12 bkground">
                <nav class="navbar p-0 m-0">
                    ...
                    <div class="d-flex justify-content-center font-weight-bold" style="text-align:center"> Meter 5 <br> <?php
                                                                                                                        $time = time();
                                                                                                                        $day = date("w", $time);
                                                                                                                        $month = date("m", $time);
                                                                                                                        $hour = date("h", $time);
        ...
        <footer class="fixed-bottom mb-1">
            <div class="container">
                <nav class="navbar d-flex justify-content-center">
                    ...
                    <a href="../graphBuilder/meter5.php" class="icon-image3" style="padding-left: 40px;"><img src="../images/9.png" height="48px" width="48px" alt=""></a>
