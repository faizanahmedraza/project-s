  ...
  <div class="container">
    ...
    <div class="mt-2">
      <form action="" method="get">
        <input type="submit" class="form-row mx-auto border-0 text-white font-weight-bold" style="font-size:34px; outline: none; text-shadow:none; cursor: pointer;" onclick="window.open('../searchview/cap.bank4.php')" value="SEARCH">
      </form>
    </div>
      ...
      on: {
        slideChange() {
          ...
          if (swiper.activeIndex === 0) {
            ...
            console.log(url);
            window.location = "cap.bank3.php";
          } else if (swiper.activeIndex === 2) {
            var url = swiper.$wrapperEl.children('.swiper-slide').eq(swiper.activeIndex);
            console.log(url);
            window.location = "cap.bank5.php";
          }
        }
      }
    });
